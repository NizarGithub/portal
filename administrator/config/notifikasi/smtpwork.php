 ...
 */
	...
	//$from="info@vishwak.com";                           /* Change this to your address like "me@mydomain.com"; */ 
	...
	//$smtp->host_name="hub.pusat.corp.pln.co.id"; //IP address       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	//$smtp->host_name="hub.pusat.corp.pln.co.id"; //IP address       /* Change this variable to the address of the SMTP server to relay, like 
	$smtp->host_name="10.1.2.26"; //IP address       /* Change this variable to the address of the SMTP server to relay, like 
	...
	//$smtp->user="andry@tabs.co.id";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	//$smtp->password="acmilan";                 /* Set to the authetication password */
