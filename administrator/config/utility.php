...
function format_tgl_waktu($tgl) {
	$tgl_waktu_ind=substr($tgl,0,4)."-".substr($tgl,5,2)."-".substr($tgl,8,2)." ".substr($tgl,11,2).":".substr($tgl,14,2);
	return $tgl_waktu_ind;
}
...
function tglwaktuformataction($tgl){
	$thn=substr($tgl,6,4);
	$bulan=substr($tgl,3,2);
	$hari=substr($tgl,0,2);
	$jam=substr($tgl,11,2);
    ...
    $tanggal = "$thn-$bulan-$hari $jam:$menit:$detik";
    return $tanggal;
}

function tglwaktuformataction1($tgl){
	$thn=substr($tgl,0,4);
...
function tglwaktuformataction2($tgl){
	$thn=substr($tgl,0,4);
	$bulan=substr($tgl,5,2);
	$hari=substr($tgl,8,2);
	$jam=substr($tgl,11,2);
	$menit=substr($tgl,14,2);
	$detik=substr($tgl,17,2);
    $tanggal = "$hari-$bulan-$thn $jam:$menit:$detik";
    return $tanggal;
}
