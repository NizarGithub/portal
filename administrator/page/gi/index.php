<?php
    $sql = mysql_query("SELECT gi.*, app.namaapp, apd.namaapd FROM gi INNER JOIN app ON gi.kodeapp = app.kodeapp INNER JOIN apd ON gi.kodeapd = apd.kodeapd") or die(mysql_error());
?>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="index.php?tambah-gi" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-plus"></i>Tambah Data</a> <a href="index.php?laporan-gi" class="btn btn-sm btn-danger"><i class="fa fa-list-alt"> </i> Laporan</a>
                    <br /><br />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Table data GI</div>
                                ...
                                <table class="table table-bordered table-hover" id="datatabel1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center; vertical-align: middle;" rowspan="2">Nama GI</th>
                                            <th style="text-align:center; vertical-align: middle;" rowspan="2">Alamat</th>
                                        ...
                                        <?php if(mysql_num_rows($sql) > 0){
                                            ...
                                            { ?>
                                                <tr style="text-align:center; vertical-align: middle;">
                                                    ...
                                                    <td>
                                                        <a title="EDIT GI" href="index.php?update-gi=<?php echo $row["kodegi"]?>" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                                        <a title="HAPUS GI" href="#" id="delete-gi=<?php echo $row["kodegi"]?>" class="delete">
