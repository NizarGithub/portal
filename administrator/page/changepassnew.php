...
$sqluser = mysql_query("SELECT * FROM login WHERE userID ='$_SESSION[username]'") or die (mysql_error());
...
if(isset($_POST["submit"])){
    ...
    $cekuser = mysql_query("SELECT * FROM login WHERE passID = '$passlama' AND kodelogin='$kode'") or die (mysql_error());
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" name="username" value="<?php echo $rowpass["userID"]; ?>" type="text" />
                                    </div>
                                </div>
                            </div>
                            <!--
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <a href="index.php" class="btn btn-large btn-warning">Kembali</a>
                                    </div>
                                </div>
