...
if(isset($_POST["submit"])){
    ...
    mysql_query("UPDATE login set  passID = '$passbaru' WHERE kodelogin = '$kode' ");

    header("location:index.php?listuser&suksesgantipass");
}

$idA = (int)mysql_real_escape_string(trim($_GET["change-passuser"]));
$sqluser = mysql_query("SELECT * FROM login WHERE kodelogin='$idA'") or die (mysql_error());
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" disabled="" class="form-control" value="<?php echo $rowpass["userID"]; ?>" />
                                        <input type="hidden" name="username" class="form-control" value="<?php echo $rowA["userID"]; ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
