var dhtmlwindow={
imagefiles:['script/images/min.gif', 'script/images/close.gif', 'script/images/restore.gif', 'script/images/resize.gif'], //Path to 4 images used by script, in that order
