...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Tabel data kosong" )
		{
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="ketik data disini" class="'+classes.sFilterInput+' i"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "<center>Tabel data kosong<center>",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(pencarian dari _MAX_ total entri)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Hasil pencarian data kosong"
		},
