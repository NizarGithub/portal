...
if(isset($_POST["login"])){
   ...
   $sql_login= mysql_query("SELECT * FROM login WHERE userID = '$username' AND passID = '$password'");
    ...
    if(mysql_num_rows($sql_login)>0)
    {
        ...
        $_SESSION["username"]       = $row_administrator["userID"];
            ...
            <div class="col-md-4 col-md-offset-4 login-panel ">
                ...
                <div class="panel panel-default btn-block">
                    <div class="panel-heading ">
                        <h3 class="panel-title text-center">Aplikasi Manajemen Dokumen</h3>
                    </div>
